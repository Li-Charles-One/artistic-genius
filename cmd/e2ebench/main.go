...
func main() {
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "e2ebench — Artistic Genius end-to-end benchmark.\n\n")
	...
	bin := flag.String("bin", "artistic-genius", "path to the artistic-genius binary")
...
func render(results []result) string {
	...
	fmt.Fprintf(&b, "## 🤖 Artistic Genius e2e benchmark\n\n")
