...
func TestEditFile(t *testing.T) {
	...
	runTool(t, editFile{}, map[string]any{"path": f, "old_string": "world", "new_string": "artistic-genius"})
	if b, _ := os.ReadFile(f); string(b) != "hello artistic-genius\n" {
...
func TestMultiEdit(t *testing.T) {
	...
	out := runTool(t, multiEdit{}, map[string]any{
		...
		"edits": []map[string]any{
			...
			{"old_string": "old", "new_string": "artisticGenius", "replace_all": true},
		},
	})
