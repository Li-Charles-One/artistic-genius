...
// to drive Artistic Genius. Many tools integrated with the v1 (main-branch) agent over
...
// older map shape that Artistic Genius v1 clients used.
...
// SessionListResult is the first and only page of sessions Artistic Genius currently
