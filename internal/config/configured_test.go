...
func TestProviderConfigured(t *testing.T) {
	...
	cases := []struct {
		...
		{"key set", ProviderEntry{APIKeyEnv: "ARTISTIC_GENIUS_TEST_KEY"}, true},
		{"key env empty", ProviderEntry{APIKeyEnv: "ARTISTIC_GENIUS_TEST_EMPTY"}, false},
		{"key env unset", ProviderEntry{APIKeyEnv: "ARTISTIC_GENIUS_TEST_MISSING"}, false},
