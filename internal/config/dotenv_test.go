...
// TestLoadDotEnvReadsGlobalCredentials proves `artistic-genius setup`'s target — the
// artistic-genius-owned credentials file in the user config dir — is loaded from any
