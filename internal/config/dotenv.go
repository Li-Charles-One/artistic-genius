...
// takes precedence), then the artistic-genius-owned global credentials file in the user
// config dir (where `artistic-genius setup` writes keys, so they resolve from any
