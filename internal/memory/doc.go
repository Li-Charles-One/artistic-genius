// Package memory implements Artistic Genius's persistent memory. It mirrors Claude
// Code's two-layer model while honoring Artistic Genius's cache-first architecture:
//
//   - Hierarchical doc memory: ARTISTIC_GENIUS.md / AGENTS.md files discovered from the
...
const (
	ScopeUser     Scope = "user"     // ~/.config/artistic-genius/ARTISTIC_GENIUS.md
	ScopeAncestor Scope = "ancestor" // a ARTISTIC_GENIUS.md above the project root
	ScopeProject  Scope = "project"  // ./ARTISTIC_GENIUS.md (committed, shared)
	ScopeLocal    Scope = "local"    // ./ARTISTIC_GENIUS.local.md (personal, git-ignored)
)

// docNames are the recognized memory filenames at each level, in load order.
// ARTISTIC_GENIUS.md is ours; AGENTS.md and CLAUDE.md are the cross-tool conventions.
...
var docNames = []string{"ARTISTIC_GENIUS.md", "AGENTS.md", "CLAUDE.md"}

// localNames are the personal, git-ignored overrides, highest precedence.
var localNames = []string{"ARTISTIC_GENIUS.local.md", "AGENTS.local.md", "CLAUDE.local.md"}
