...
func TestComposeAppendsAfterBase(t *testing.T) {
	base := "BASE PROMPT"
	set := &Set{Docs: []Source{{Path: "/p/ARTISTIC_GENIUS.md", Scope: ScopeProject, Body: "Use tabs."}}}
	got := Compose(base, set)
...
func TestDiscoverPrecedenceOrder(t *testing.T) {
	...
	mustWrite(t, filepath.Join(user, "ARTISTIC_GENIUS.md"), "USER LEVEL")
	mustWrite(t, filepath.Join(proj, "ARTISTIC_GENIUS.md"), "PROJECT LEVEL")
	mustWrite(t, filepath.Join(proj, "ARTISTIC_GENIUS.local.md"), "LOCAL LEVEL")
...
func TestImportResolution(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "ARTISTIC_GENIUS.md"), "Top line\n@shared.md\nBottom line")
...
func TestImportCycleDoesNotHang(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "ARTISTIC_GENIUS.md"), "@a.md")
...
func TestImportDiamondAndCycle(t *testing.T) {
	...
	mustWrite(t, filepath.Join(projCycle, "ARTISTIC_GENIUS.md"), "@cycle1.md")
