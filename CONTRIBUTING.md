# Contributing to Artistic Genius

Thank you for your interest in contributing to Artistic Genius! This guide covers
...
```bash
cd artistic-genius
go build ./cmd/artistic-genius    # builds the CLI binary
...
| Directory | Purpose |
|-----------|---------|
| `cmd/artistic-genius` | CLI entry point |
...
| `internal/memory` | ARTISTIC_GENIUS.md hierarchy + auto-memory |
