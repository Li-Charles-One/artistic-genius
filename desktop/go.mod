module artistic-genius/desktop
...
// the same artistic-genius/internal/* kernel (the import path stays under artistic-genius/, so
...
require artistic-genius v0.0.0
