...
export const en = {
  ...
  "sidebar.navigation": "Artistic Genius navigation",
  ...
  "rightDock.panel": "Workspace panel",
  ...
  "caps.updateManagedByNpx": "Managed by npx/npm; Artistic Genius does not pin this runtime",
  "caps.updateManagedByNpxShort": "Updates via npx",
  "caps.updateBundledWithApp": "Updated with the Artistic Genius app",
  ...
  "welcome.tagline": "Describe a goal, paste an error, or reference files. Artistic Genius can reason, edit, and verify.",
  ...
  "memory.noDocs": "No ARTISTIC_GENIUS.md found. Quick-add one above.",
  ...
  "memory.emptySavedBody": "Save durable background only when it should help future Artistic Genius sessions in this project.",
  ...
  "settings.closeBehavior.quit": "Quit Artistic Genius",
  ...
  "settings.agentRuntimeHint": "Used as global defaults; ./artistic-genius.toml can override them per project. 0 means unlimited.",
  ...
  "settings.botInstallSubtitle": "Once connected, Artistic Genius can be used from chat.",
  ...
  "settings.style.graphite.desc": "Paper white, graphite text, and orange accents — restrained, editor-like workspace.",
  ...
  "settings.style.slate.desc": "Cool gray workspace with brand blue and crisp hairlines for dense professional scanning.",
  ...
  "settings.pageDesc.memory": "Manage preferences, project conventions, and instruction files Artistic Genius keeps referencing.",
  ...
  "settings.addProvider.officialChoiceHint": "Choose from Artistic Genius presets for DeepSeek and Mimo.",
  ...
  "settings.hooksPathProjectHint": "Project hooks are saved to .artistic-genius/settings.json in the current workspace.",
  ...
  "settings.hooksGlobalHint": "Saved globally. Restart Artistic Genius to load new hooks.",
  "settings.hooksProjectHint": "Saved in this workspace. Project hooks load after trust and a Artistic Genius restart.",
  ...
  "updater.autoCheckHint": "When off, Artistic Genius won't check automatically when it opens. You can still check manually here.",
  ...
  "onboarding.title": "Connect Artistic Genius",
  ...
  // crash page
  "crash.title": "Artistic Genius hit an error — send us the report, or copy it",
  "crash.copy": "Copy",
  ...
  "performanceReport.title": "Artistic Genius noticed a responsiveness issue",
  ...
  "mock.askQ2Header": "Artistic Genius build",
  "mock.askQ2Prompt": "What do you want to do about the missing artistic-genius binary?",
  ...
  "mock.changedFile2Path": ".artistic-genius/project.md",
};
