...
// credentialsPath is the artistic-genius-owned global secrets file the settings panel
// writes API keys to — the same file `artistic-genius setup` writes and config.loadDotEnv
