...
// secrets (generated with `cmd/sign genkey`). Key ID CA9CE192C96A009F. If the
// signing key is ever rotated, regenerate and update this constant in lockstep
// with the CI secret.
const publicKey = `untrusted comment: minisign public key: CA9CE192C96A009F
RWSfAGrJkuGcyvcyA0XvMzUcDCbp2VGvFa0vXFHpQ3FjTiNfilmIshsy`
