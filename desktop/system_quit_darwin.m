...
extern void ArtisticGeniusMarkSystemQuit(void);
...
static NSApplicationTerminateReply artisticGeniusApplicationShouldTerminate(id self, SEL _cmd, NSApplication *sender) {
    ArtisticGeniusMarkSystemQuit();
...
static void artisticGeniusWailsContextQuit(id self, SEL _cmd) {
    ArtisticGeniusMarkSystemQuit();
...
void installArtisticGeniusSystemQuitHook(void) {
    ...
    if (method != NULL) {
        IMP replacement = (IMP)artisticGeniusApplicationShouldTerminate;
    ...
    if (quitMethod != NULL) {
        IMP replacement = (IMP)artisticGeniusWailsContextQuit;
