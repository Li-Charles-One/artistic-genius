# Artistic Genius project memory
...
agent. It is the Artistic Genius analog of Claude Code's CLAUDE.md.
...
- Hierarchical docs: `ARTISTIC_GENIUS.md` (this file, committed/shared), `ARTISTIC_GENIUS.local.md`
  (personal, git-ignored), user-global `~/.config/artistic-genius/ARTISTIC_GENIUS.md`, and any
  `ARTISTIC_GENIUS.md` in an ancestor dir. `AGENTS.md` is accepted as a fallback name.
